...
await Bun.write('src/data/lang.const.toml', TOML.stringify(Object.fromEntries(Object.entries(lang).map(([ns, keys]) => (
  [ns, Object.fromEntries(keys.map((key) => [key, ''] as const))]
)))))
