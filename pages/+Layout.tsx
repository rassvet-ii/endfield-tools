...
export default function Layout({ children }: { children: React.ReactNode }) {
  const { title = '基質補助', title_en = 'ESSENCE' } = useData<{ title?: string, title_en?: string }>() ?? {};

  return <div className='max-w-screen grid c1-1fr c2-auto/lg c3-1fr gap-x-4 r1-auto r2-1fr'>
